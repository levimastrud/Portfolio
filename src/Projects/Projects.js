        ...
        <div>
            ...
            <div className='projects-and-description-wrapper' style={{ gridTemplateColumns }}>
                <div className='project-container'>
                    <img alt='project' onClick={() => learnAboutProject(project1)} className={`project-image ${selectedProject === 'Zenn' ? 'selected' : ''}`} src='https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80' />
                    <img alt='project' onClick={() => learnAboutProject(project2)} className={`project-image ${selectedProject === 'TicketGo' ? 'selected' : ''}`} src='https://images.unsplash.com/photo-1634848860108-6d8368f5a0b3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1964&q=80' />
                    <img alt='project' onClick={() => learnAboutProject(project3)} className={`project-image ${selectedProject === 'Forged in Isolation' ? 'selected' : ''}`} src='https://images.unsplash.com/photo-1633907284646-7abf4a195875?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=764&q=80' />
                    <img alt='project' onClick={() => learnAboutProject(project4)} className={`project-image ${selectedProject === 'Enigma Bistro' ? 'selected' : ''}`} src='https://images.unsplash.com/photo-1627637819794-fba32f82be16?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1632&q=80' />
                </div>
